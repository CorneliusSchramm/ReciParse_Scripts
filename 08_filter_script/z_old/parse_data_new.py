...
DIFF_FRONT_BACK = False     #Differentiate between token distance front and back? (auch in rel_model anpassen)
FRONT = 5
BACK = 30
                                ...
                                for x2 in span_starts:
                                    if ents_dict[x2][0] in ["Z","TOOL","ATTR","TEMP","DAUER","ZEITP","PRÄP"]:      #filter entity type
                                        ...
                                        if DIFF_FRONT_BACK == True:
                                             ...
                                             if (x1 - x2) >= 0 and (x1 - x2 ) <= FRONT:
                                                 rels[(x1, x2)] = {}
                                            
                                            elif (x1 - x2) < 0 and (x1 - x2) >= BACK: 
                                                rels[(x1, x2)] = {}
                                            else: 
                                                pass 
