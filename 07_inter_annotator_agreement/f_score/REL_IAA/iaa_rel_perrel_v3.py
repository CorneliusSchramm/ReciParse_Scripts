    ...
    for entity in rel_list:
        try: 
            if entity["label"] in rels_to_comp:
                ent_set.add((entity["head_span"]["token_start"], entity["head_span"]["token_end"],
                 entity["child_span"]["token_start"], entity["child_span"]["token_end"] , entity["label"]))   #start = start character, end = end character
...
ov_dict_graf = {example["text"] : create_ent_set(example["relations"], rels_to_compare) for example in ov_recipes_graf}
ov_dict_hoff = {example["text"] : create_ent_set(example["relations"], rels_to_compare) for example in ov_recipes_hoff}
ov_dict_jthn = {example["text"] : create_ent_set(example["relations"], rels_to_compare) for example in ov_recipes_jthn}
...
print("")
print(f"####   Individual {rels_to_compare} comparison   ####")
...
print("")
print(f"####   Overall {rels_to_compare} statistics   ####")
