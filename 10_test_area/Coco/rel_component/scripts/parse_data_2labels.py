...
SYMM_LABELS = ["Binds"]
MAP_LABELS = {
    "ARG0": "Object", # trying with 2 labels
    "ARG1": "Object",
    "ARG": "Attribute",
}
...
def main(json_loc: Path, train_file: Path, dev_file: Path, test_file: Path):
    ...
    with json_loc.open("r", encoding="utf-16") as jsonfile:
                ...
                try:
                    ...
                    for relation in relations:
                        ...
                        if label not in rels[(start, end)]:
                            ...
                            pos += 1 # In jder start end Relation in example, ist in rels {(1,2)= {Object:1.0}}
